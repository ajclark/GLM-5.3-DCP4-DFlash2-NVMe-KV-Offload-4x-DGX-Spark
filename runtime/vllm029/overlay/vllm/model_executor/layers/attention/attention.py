...
class Attention(nn.Module, AttentionLayerBase):
    ...
    def get_kv_cache_spec(self, vllm_config: VllmConfig) -> KVCacheSpec | None:
        ...
        if self.sliding_window is not None:
            ...
            if (shared_page is None and vllm_config.model_config.is_deepseek_mla
                    and vllm_config.speculative_config is not None
                    and vllm_config.speculative_config.method == "dflash"):
                # Keep the replicated draft's 64-token pages. Choosing FA2's
                # minimum 16 here consumes four times as many shared pool IDs.
