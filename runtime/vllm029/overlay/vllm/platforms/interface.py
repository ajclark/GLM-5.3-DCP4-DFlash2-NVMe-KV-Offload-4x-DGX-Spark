...
class Platform:
    ...
    def _align_heterogeneous_kv_block_size(
        ...
        """
        # MLA latent pages and a sliding-window drafter have different head
        # geometries. The ordinary K/V dtype ratio below cannot describe them;
        # native block-outermost packing keeps their physical pages separate.
